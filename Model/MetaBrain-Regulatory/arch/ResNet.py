...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_target):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.maxpool1 = nn.MaxPool1d(kernel_size = 3, stride = 3, padding = 0)
        self.maxpool2 = nn.MaxPool1d(kernel_size = 3, stride = 3, padding = 0)
        self.maxpool3 = nn.MaxPool1d(kernel_size = 3, stride = 3, padding = 0)
        self.maxpool4 = nn.MaxPool1d(kernel_size = 3, stride = 3, padding = 0)
        self.maxpool5 = nn.MaxPool1d(kernel_size = 3, stride = 3, padding = 0)
